...
public class OyuncuDAO extends SuperDAO implements DaoArayuz<Oyuncu> {

    private static OyuncuDAO oyuncuDao = null;

    private OyuncuDAO() {
    }

    public static OyuncuDAO getoyuncuDao() {
        if (oyuncuDao == null) {
            oyuncuDao = new OyuncuDAO();
        }
        return oyuncuDao;
    }
    ...
    @Override
    public boolean insert(Oyuncu oyuncu) {
    ...
    @Override
    public boolean delete(Oyuncu oyuncu) {
    ...
    @Override
    public boolean update(Oyuncu oyuncu) {
